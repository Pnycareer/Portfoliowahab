/* Manifesto content.
 *
 * The five promise areas and their descriptions are the candidate's stated
 * platform. The "objectives" bullets expand on each promise and are
 * illustrative supporting detail for this demo build.
 */
...
export const manifesto = [
  ...
  },
  {
    ...
    category: "Exports",
    icon: "Globe",
    title: "Global Market Access & IT Exports",
    short:
      "International linkages, B2B opportunities and partnerships that open global markets to Associate companies.",
    detail:
      "Strengthen international linkages, B2B opportunities and strategic partnerships to help Associate companies access global markets, generate business and contribute more to Pakistan's IT exports.",
    objectives: [
  ...
  },
  {
    ...
    category: "Technology",
    icon: "Cpu",
    title: "Gaming, AI & Emerging Technologies",
    short:
      "A stronger gaming and technology ecosystem, with support for companies adopting AI and emerging tech.",
    detail:
    ...
    impact:
      "More Pakistani companies building competitive products in gaming, AI and emerging tech.",
  },
  {
    slug: "associate-voice",
    category: "Representation",
    icon: "Users",
    title: "Associate Voice & Industry Collaboration",
    short:
      "Actively representing Associate members and strengthening collaboration across the ecosystem.",
    detail:
